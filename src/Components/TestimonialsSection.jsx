          ...
          {TESTIMONIALS.map((t) => (
            ...
            >
              ...
              <div className="flex items-center justify-between border-t border-white/[0.04] pt-4 mt-auto">
                <div>
                  <p className="font-sans-brand text-[11px] tracking-[0.15em] font-medium text-white uppercase">
                    {t.name}
                  </p>
                  <p className="font-sans-brand text-[10px] tracking-wide text-zinc-500 mt-0.5">
                    {t.city}
                  </p>
                </div>
